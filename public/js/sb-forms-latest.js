(() => {
  ...
  const a = (t) => !!["checkbox", "radio"].find((e) => e === t.type),
    r = (t, i) => {
      ...
      if ((a(t) && (r = t.parentElement.parentElement), "object" == typeof i)) {
        if (
          ((c = i.validate()),
          (s = get(`[data-sb-feedback="${t.id}:${i.name}"]`)),
          !s)
        )
        ...
        if (a(t))
          try {
            s = get(`[data-sb-feedback="${t.name}:${i}"]`);
          } catch (e) {
            throw new Error(`VALIDATION_NOT_SETUP_FOR: ${t.name}:${i}`);
          }
        else
          try {
            s = get(`[data-sb-feedback="${t.id}:${i}"]`);
          } catch (e) {
  ...
  const l = (r, o) => {
      ...
      const c = [],
        ...
        submitBtn = get("#submitButton", r),
        successMsg = get("#submitSuccessMessage", r),
        errorMsg = get("#submitErrorMessage", r),
      ...
      const y = (e) => {
          return (
            ...
            (i = void 0),
            (a = function* () {
              e.preventDefault(), submitBtn.classList.add("d-none");
              try {
                console.log(u(E)),
                  d
                ...
                console.error(t), errorMsg.classList.remove("d-none");
              }
              var n;
            }),
        ...
        L = (t) => y(t);
      submitBtn.addEventListener("click", L);
      const w = () => {
        E.reduce((t, n) => {
          if (a(n)) {
      ...
      return (
        ...
        {
          tearDown: () => {
            submitBtn.removeEventListener("click", L),
